...
import 'package:telescope_driver/model/apis/api_exception.dart';
...
class ApiService extends BaseService {
  ...
  Future<dynamic> getResponse(
    ...
    try {
      ...
      log('FILE NAME :${body!.values.toList().first.toString()}');
      log('FILE NAME :${ConstUtils.kGetFileName(body.values.toList().first)}');
      ...
      ///------------------------------------ FILE UPLOAD METHOD -------------------------------------///
        ...
        request.files.add(new http.MultipartFile.fromString(
            'image', body.values.toList().first..toString(),
            filename: ConstUtils.kGetFileName(
                body.values.toList().first.toString())));
      ...
      ///------------------------------------ POST METHOD -------------------------------------///
        ...
        print('RES CODE :${result.statusCode}');
