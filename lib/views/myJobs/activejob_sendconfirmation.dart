...
import 'activejob_requestfromcustomer.dart';
import 'activejob_verifypickuplocation.dart';

class ActiveJobSendConfirmation extends StatefulWidget {
  const ActiveJobSendConfirmation({Key? key}) : super(key: key);

  @override
  State<ActiveJobSendConfirmation> createState() =>
      _ActiveJobSendConfirmationState();
}

class _ActiveJobSendConfirmationState extends State<ActiveJobSendConfirmation> {
  @override
            ...
            child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    //         builder: (context) => ActiveJobsOffline()));
                    //   },
