...
import 'activejob_reachdestination.dart';
import 'activejob_verifypickuplocation.dart';

class ActiveJobOutforDelivery extends StatefulWidget {
  const ActiveJobOutforDelivery({Key? key}) : super(key: key);

  @override
  State<ActiveJobOutforDelivery> createState() =>
      _ActiveJobOutforDeliveryState();
}

class _ActiveJobOutforDeliveryState extends State<ActiveJobOutforDelivery> {
  @override
                        ...
                        CustomButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        ActiveJobReachAtDestinationAndReceived()));
                          },
                        )
                      ],
                    ),
