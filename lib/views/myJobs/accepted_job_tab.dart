...
import 'package:telescope_driver/views/myJobs/accepted_job_detail.dart';
import '../../widgets/custombutton.dart';

import 'activejob_reachpickuplocation.dart';

class AcceptedJobTab extends StatefulWidget {
  const AcceptedJobTab({Key? key}) : super(key: key);

  @override
  State<AcceptedJobTab> createState() => _AcceptedJobTabState();
}

class _AcceptedJobTabState extends State<AcceptedJobTab> {
  @override
                ...
                CustomButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => AcceptedJobDetailPage(
                                  showContact: true,
                                )));
                  },
                )
