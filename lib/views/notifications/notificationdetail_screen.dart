...
import '../myjobs/activejob_reachpickuplocation.dart';

class NotificationDetailPage extends StatefulWidget {
  final bool showContact;

  const NotificationDetailPage({Key? key, this.showContact = false})
      : super(key: key);
...
class _NotificationDetailPageState extends State<NotificationDetailPage> {
  ...
  void declineOfferBottomSheet() {
    int? offerDeclineSelected;
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(
                        "Offer declined by ",
                        style: FontTextStyle.gilroyW7S16darkBlack,
                      ),
                      Text(
                        "Taria Jorden",
                        style: FontTextStyle.gilroyW7Sp14darkAccent,
                      ),
                    ],
                  ),
                  SizedBox(
                      ...
                      return ListTile(
                        leading: GestureDetector(
                          ...
                          child: Container(
                            ...
                            width: 7.w,
                            decoration: BoxDecoration(
                              color: offerDeclineSelected == index
                                  ? ColorUtils.primaryColor
                                  : ColorUtils.white,
                        ...
                        title: Text(
                          "Vehicle mismatch",
                          style: FontTextStyle.gilroyW7S13darkBlack,
                        ),
                      );
                    },
                  ),
                  CustomInputField(
                    fieldName: 'Write reason for declining',
                  ),
                  SizedBox(
                    height: 5.w,
                  ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomInputField(
                fieldName: 'Submit your counter offer',
              ),
              SizedBox(
                height: 5.w,
              ),
